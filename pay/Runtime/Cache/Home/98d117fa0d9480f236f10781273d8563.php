...
<nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
    ...
    <div class="header-right">
        ...
        <a href="login.html"  title="Logout"><i class="fa fa-exclamation-circle fa-2x"></i></a>
...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a class="active-menu" href="/index.php/Home/Index/body"><i class="fa fa-dashboard "></i>Dashboard</a>
            </li>
            <li>
                <a href="#"><i class="fa fa-desktop "></i>UI Elements <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="/index.php/Home/Index/body"><i class="fa fa-toggle-on"></i>Tabs & Panels</a>
                    </li>
                    <li>
                        <a href="/index.php/Home/Index/left"><i class="fa fa-bell "></i>Notifications</a>
                    </li>
                    <li>
