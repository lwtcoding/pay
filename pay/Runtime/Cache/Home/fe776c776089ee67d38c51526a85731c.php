        ...
        <div class="col-md-6 col-md-offset-3 col-xs-10 col-xs-offset-1">
                ...
                <div class="form-group" style="margin-top: 35px;">
                    <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                        <a href="/index.php/home/staff/boundwx?mid=<?php echo cookie('loginStaff')['mid'] ?>&store_id=<?php echo cookie('loginStaff')['store_id'] ?>" class="btn btn-primary form-control">绑定微信号</a>
                    </div>
                </div>
