...
<head>
    ...
    <link href="/Public/css/dropzone/dropzone.css" rel="stylesheet" />
    <link href="/Public/css/iCheck/custom.css" rel="stylesheet" />
    <link href="/Public/css/card_control.css" rel="stylesheet" />
    <link href="/Public/css/section_card_notification.css" rel="stylesheet" />
...
<div id="page-inner" >
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div id="preload" ></div>
            <h1 class="page-head-line">卡券管理</h1>
            <div>
                <ol class="breadcrumb">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="group">
                                <div id="js_preview_area" class="media_preview_area">
                                    <div class="msg_card">
                                        <div class="msg_card_inner">
                                            <p class="msg_title" style="margin: 0;"><?php echo ($card_type['zhname']); ?></p>
                                                    ...
                                                    <li class="msg_card_section js_preview itemdiv">
                                                        <div href="" class="li_panel">
                                                            <div class="li_content">
                                                                <p><?php echo ($card_type['zhname']); ?>详情</p>
                                                            </div>
                                ...
                                <form id="js_editform" name="js_editform" class="media_edit" novalidate="novalidate" method="POST" action="/index.php/admin/card/docreateKq">
                                                        ...
                                                        <div class="input_submsg">
                                                            <div class="frm_controls frm_vertical_lh">
                                                                <div class="brand_item">
                                                                    <div class="brand_img">
                                                                        <img src="/Uploads/<?php echo $wxcouponSet['logourl']?>" id="js_logo_url_preview_1" />
                                                                    </div>
                                                                    <input type="hidden" value="<?php echo $wxcouponSet['wxlogourl']?>" id="js_logo_url" name="base_info[logo_url]" />
                                                        ...
                                                        <div class="color_picker dropdown_menu" id="js_colorpicker">
                                                            ...
                                                            <div class="dropdown_data_container jsDropdownList" style="display: none;">
                                                                <ul class="dropdown_data_list">
                                                                    <?php
 if(!empty($wxCardColor)){ foreach($wxCardColor as $key=>$wxc){ ?>
                                                                    <li class="dropdown_data_item wxcolor<?php echo $key;?>">
                                                                        <a class="jsDropdownItem" href="javascript:;" onclick="GetTishColor('<?php echo $wxc['name'];?>','<?php echo $wxc['value'];?>');return false;" style="background-color:<?php echo $wxc['value'];?>">
                                                                            <?php echo $wxc['value'];?>
                                                                        </a>
                                                                    </li>
                                                                    <?php
                                                    ...
                                                    <div class="appmsg_edit_item frm_normal">
                                                        <label class="frm_label" for=""> <strong class="title"><?php echo ($card_type['zhname']); ?>标题</strong> </label>
                                                    ...
                                                    <div class="ibox float-e-margins">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped">
                                                                ...
                                                                <tbody>
                                                                <?php if(empty($shoplist)): ?><tr>
                                                                        <td colspan="3">您还没有创建店铺，请到微信公共平台创建</td>
                                                                    </tr>
                                                                    <?php else: ?>
                                                                    <?php if(is_array($shoplist)): $i = 0; $__LIST__ = $shoplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$svv): $mod = ($i % 2 );++$i;?><tr>
                                                                            ...
                                                                            <td><?php echo ($svv['business_name']); ?> （<?php echo ($svv['branch_name']); ?>）</td>
...
<script  src="/Public/js/iCheck/icheck.min.js"></script>
<script  src="/Public/js/commonfunc.js?var=<?php echo time() ?>"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(".dropz").dropzone({
            url: "/index.php/admin/card/uploadImg",
                ...
                this.on("success", function(file,responseText) {
                   // var rept = $.parseJSON(responseText);
                    ...
                    if(responseText.result){
                        $('#js_logo_url_preview,#js_logo_url_preview_1').attr('src','/Uploads/'+responseText.data.logourl);
                        $('#js_logo_url').val(responseText.data.wxlogourl);
                    }else{
                        swal({
                            title: "上传失败",
